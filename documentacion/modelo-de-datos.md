...
| Compatibilidad de calendario | Para rangos de hasta 31 días, `Query` acotada de relaciones y `BatchGetItem` de hasta 500 claves de sesión; los resultados se deduplican con `GSI2`. |
